# Getting Started with Number to LCD kata in Java
...
To run the application from IntelliJ, run all the tests in the [LcdTest](./src/test/java/com/murex/LcdTest.java) 
class. 
...
[INFO]  T E S T S
[INFO] -------------------------------------------------------
[INFO] Running LcdTest
[WARNING] Tests run: 1, Failures: 0, Errors: 0, Skipped: 1, Time elapsed: 0.045 s - in LcdTest
[INFO]
[INFO] Results:
[INFO]
...
[INFO]
[INFO]
[INFO] --- maven-jar-plugin:3.2.0:jar (default-jar) @ Kata-NumberToLcd ---
```
